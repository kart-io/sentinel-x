...
// SwaggerInfousercenter holds exported Swagger Info so clients can modify it
var SwaggerInfousercenter = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8081",
	BasePath:         "/",
	Schemes:          []string{},
	...
	InfoInstanceName: "usercenter",
	SwaggerTemplate:  docTemplateusercenter,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfousercenter.InstanceName(), SwaggerInfousercenter)
}
