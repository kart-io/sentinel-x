...
const file_api_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x11api/v1/user.proto\x12\vapi.user.v1\"\x1d\n" +
	...
	"\vUserService\x12>\n" +
	"\aGetUser\x12\x18.api.user.v1.UserRequest\x1a\x19.api.user.v1.UserResponseBDZBgithub.com/kart-io/sentinel-x/example/server/user-center/api/v1;v1b\x06proto3"
