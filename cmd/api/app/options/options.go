// Package options contains flags and options for initializing the API server.
package options
...
import (
	...
	apisvc "github.com/kart-io/sentinel-x/internal/api"
...
// Config builds an apisvc.Config based on ServerOptions.
func (o *ServerOptions) Config() (*apisvc.Config, error) {
	return &apisvc.Config{
