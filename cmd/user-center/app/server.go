// Package app provides the user center server application.
package app
...
import (
	...
	"github.com/kart-io/sentinel-x/cmd/user-center/app/options"
	"github.com/kart-io/sentinel-x/pkg/infra/app"
)

const (
	// Name is the name of the application.
	Name = "sentinel-user-center"

	// commandDesc is the description of the command.
	commandDesc = `Sentinel-X User Center Service
