...
const (
	HelloService_SayHello_FullMethodName       = "/api.hello.v1.HelloService/SayHello"
	HelloService_SayHelloStream_FullMethodName = "/api.hello.v1.HelloService/SayHelloStream"
)
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/api/hello/v1/hello.proto",
}
