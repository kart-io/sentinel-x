...
//	}
//	defer client.Close()
func NewFactory(opts *etcd.Options) *Factory {
	return &Factory{
		opts: opts,
	}
}
...
//	customOpts := etcd.NewOptions()
//	customOpts.Endpoints = []string{"etcd-prod:2379"}
//	client, err := factory.CreateWithOptions(ctx, customOpts)
func (f *Factory) CreateWithOptions(ctx context.Context, opts *etcd.Options) (*Client, error) {
