...
// The factory can be used to create multiple MongoDB client instances
...
func NewFactory(opts *mongodbOpts.Options) *Factory {
	return &Factory{
		opts: opts,
	}
}

// Create creates and initializes a new MongoDB client.
...
//
// Returns:
// - storage.Client: A fully initialized MongoDB client
...
func (f *Factory) Options() *mongodbOpts.Options {
	return f.opts
}
