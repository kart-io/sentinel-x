...
import (
	...
	"github.com/kart-io/sentinel-x/pkg/postgres"
	"github.com/kart-io/sentinel-x/pkg/redis"
...
type RedisOptions = redisOpts.Options
...
type MySQLOptions = mysqlOpts.Options
...
type PostgresOptions = pgOpts.Options
...
type MongoDBOptions = mongoOpts.Options
...
type EtcdOptions = etcdOpts.Options
