...
func NewSimpleFactory(opts *options.Options) *SimpleFactory {
...
func (f *SimpleFactory) Options() *options.Options {
	return f.opts
}
...
func (f *Factory) Create(name string, opts *options.Options) (*Client, error) {
...
func (f *Factory) CreateWithContext(ctx context.Context, name string, opts *options.Options) (*Client, error) {
	f.mu.Lock()
	defer f.mu.Unlock()
...
func (f *Factory) GetOrCreate(name string, opts *options.Options) (*Client, error) {
...
func (f *Factory) GetOrCreateWithContext(ctx context.Context, name string, opts *options.Options) (*Client, error) {
