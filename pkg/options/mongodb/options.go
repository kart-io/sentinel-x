...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	fs.StringVar(&o.URI, "mongodb.uri", o.URI, "MongoDB URI (mongodb://...)")
	fs.StringVar(&o.Host, "mongodb.host", o.Host, "MongoDB host")
	fs.IntVar(&o.Port, "mongodb.port", o.Port, "MongoDB port")
	fs.StringVar(&o.Username, "mongodb.username", o.Username, "MongoDB username")
	fs.StringVar(&o.Password, "mongodb.password", o.Password, "MongoDB password (DEPRECATED: use MONGODB_PASSWORD env var instead)")
	fs.StringVar(&o.Database, "mongodb.database", o.Database, "MongoDB database")
	fs.Uint64Var(&o.MaxPoolSize, "mongodb.max-pool-size", o.MaxPoolSize, "MongoDB max pool size")
	fs.Uint64Var(&o.MinPoolSize, "mongodb.min-pool-size", o.MinPoolSize, "MongoDB min pool size")
	fs.DurationVar(&o.MaxIdleTime, "mongodb.max-idle-time", o.MaxIdleTime, "MongoDB max idle time")
	fs.DurationVar(&o.MaxConnIdleTime, "mongodb.max-conn-idle-time", o.MaxConnIdleTime, "MongoDB max connection idle time")
	fs.DurationVar(&o.ConnectTimeout, "mongodb.connect-timeout", o.ConnectTimeout, "MongoDB connect timeout")
	fs.DurationVar(&o.SocketTimeout, "mongodb.socket-timeout", o.SocketTimeout, "MongoDB socket timeout")
	fs.DurationVar(&o.ServerSelectionTimeout, "mongodb.server-selection-timeout", o.ServerSelectionTimeout, "MongoDB server selection timeout")
	fs.StringVar(&o.ReplicaSet, "mongodb.replica-set", o.ReplicaSet, "MongoDB replica set")
	fs.StringVar(&o.AuthSource, "mongodb.auth-source", o.AuthSource, "MongoDB auth source")
	fs.BoolVar(&o.Direct, "mongodb.direct", o.Direct, "MongoDB direct connection")
}
